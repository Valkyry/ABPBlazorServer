...
namespace Example.Migrations
{
    ...
    [Migration("20230911095115_version_2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Example.Domain.Aggregates.CategoryAggregate.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Example.Domain.Aggregates.FileAggregate.File", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Example.Domain.Aggregates.PatientAggregate.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Example.Domain.Aggregates.PatientAggregate.PatientFileStore", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PatientFileStore", (string)null);
                });
            ...
            modelBuilder.Entity("Example.Domain.Aggregates.PatientAggregate.Patient", b =>
                {
                    b.HasOne("Example.Domain.Aggregates.CategoryAggregate.Category", "Category")
                        .WithOne("Patient")
                        .HasForeignKey("Example.Domain.Aggregates.PatientAggregate.Patient", "CategoryId");
            ...
            modelBuilder.Entity("Example.Domain.Aggregates.PatientAggregate.PatientFileStore", b =>
                {
                    b.HasOne("Example.Domain.Aggregates.PatientAggregate.Patient", null)
                        .WithMany("FileStores")
